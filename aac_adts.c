...
//unsigned char adts[7] = {0xff, 0xf1, 0x50, 0x80, 0x03, 0xdf, 0xfc};
//unsigned char adts[7] = {0xFF, 0xF1, 0x50, 0x80, 0x45, 0xA1, 0xE8}; //lc
//unsigned char adts[7] = {0xFF, 0xF1, 0x5C, 0x80, 0x5C, 0xC1, 0x8C};   //he v1
//unsigned char adts[7] = {0xff, 0xf1, 0x5c, 0x40, 0x2e, 0x61, 0x8c}; //he v2
unsigned char adts[7] = {0xff, 0xf1, 0x54, 0x80, 0x30, 0x5f, 0xfc}; //eti adts 
